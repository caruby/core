  ...
  module Domain
    ...
    module Attributes
      ...
      def nondomain_attributes
        @ndom_attrs ||= attribute_filter { |attr_md| attr_md.java_property? and attr_md.nondomain? }
      end
  
      # @return [<Symbol>] the non-domain Java property wrapper attributes
      def nondomain_java_attributes
        @ndom_java_attrs ||= nondomain_attributes.compose { |attr_md| attr_md.java_property? }
      end
      ...
      # @return [<Symbol>] the {Attribute#fetch_saved?} attributes
      def saved_attributes_to_fetch
        @sv_ftch_attrs ||= domain_attributes.compose { |attr_md| attr_md.fetch_saved? }
      end
      ...
      def mandatory_attributes
        @mnd_attrs ||= collect_mandatory_attributes
      end
      ...
      def fetched_dependent_attributes
        @fch_dep_attrs ||= (fetched_domain_attributes & dependent_attributes).to_a
      end
      ...
      def saved_dependent_attributes
        @sv_dep_attrs ||= attribute_filter { |attr_md| attr_md.dependent? and attr_md.saved? }
      end
      ...
      def saved_independent_attributes
        @sv_ind_attrs ||= attribute_filter { |attr_md| attr_md.independent? and attr_md.saved? }
      end
  
      # @return [<Symbol>] the domain {Attribute#saved?} attributes
      def saved_domain_attributes
        @sv_dom_attrs ||= domain_attributes.compose { |attr_md| attr_md.saved? }
      end
  
      # @return [<Symbol>] the non-domain {Attribute#saved?} attributes
      def saved_nondomain_attributes
        @sv_ndom_attrs ||= nondomain_attributes.compose { |attr_md| attr_md.saved? }
      end
  
      # @return [<Symbol>] the {Attribute#volatile?} {#nondomain_attributes}
      def volatile_nondomain_attributes
        @vl_ndom_attrs ||= nondomain_attributes.compose { |attr_md| attr_md.volatile? }
      end
      ...
      def fetched_attributes
        @fch_attrs ||= attribute_filter { |attr_md| attr_md.fetched? }
      end
      ...
      def fetched_domain_attributes
        @fch_dom_attrs ||= domain_attributes.compose { |attr_md| attr_md.fetched? }
      end
