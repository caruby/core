  ...
  class Database
    module Writer
      ...
      class TemplateBuilder
        ...
        # * The {Jinx::Properties#unproxied_savable_template_attributes} filtered as follows:
        ...
        # * The {Jinx::Properties#proxied_savable_template_attributes} are included if and
        ...
        # @param [Properties::Filter] the savable attribute filter
        # @return [Properties::Filter] the composed attribute filter
