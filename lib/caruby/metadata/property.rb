...
module Jinx
  ...
  class Property
    ...
    SUPPORTED_FLAGS = [
      ...
      :owner, :cascaded, :no_cascade_update_to_create, :saved, :unsaved, :mandatory, :optional, :fetched, :unfetched,
      :include_in_save_template, :fetch_saved, :create_only, :update_only, :unidirectional, :volatile].to_set
