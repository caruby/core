...
class PersonTest < Test::Unit::TestCase
  def test_middle_but_no_first
    assert_raises(Jinx::ValidationError) { || CaRuby::Person::Name.new('Longfellow', nil, 'Wadsworth').validate }
  end

  def test_empty_middle_and_no_first
    assert_raises(Jinx::ValidationError) { || CaRuby::Person::Name.new(nil, '').validate }
  end
